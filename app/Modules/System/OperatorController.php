...
class OperatorController extends SystemController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->view('operator.index', $this->operatorService->loadViewData());
    }

    public function create(Request $request)
    {
        return $this->view('operator.create', $this->operatorService->create());
    }
    ...
    {
        return $this->view('operator.create', $this->operatorService->edit($id));
    }
