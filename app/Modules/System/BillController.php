...
class BillController extends SystemController
{
    ...
    public function __construct(BillService $operatorService)
    {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        return $this->view('bill.index', $this->operatorService->loadViewData());
    }

    public function create(Request $request)
    {
        return $this->view('bill.create', $this->operatorService->create());
    }
    ...
    {
        return $this->view('bill.create', $this->operatorService->edit($id));
    }
