...
@section('content')
    ...
    <div class="row gx-10 ">
        ...
        <div class="col-lg-6">
            ...
            <!--begin::Input group-->
            <div class="mb-5">
                {!! Form::text('two_fa_secret',isset($result->two_fa_secret) ? $result->two_fa_secret:old('two_fa_secret'),['class'=>'form-control form-control-solid']) !!}
                <div class="invalid-feedback" id="two_fa_secret-form-error"></div>
            </div>
