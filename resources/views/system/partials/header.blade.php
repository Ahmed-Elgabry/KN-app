...
<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    <!--begin::Header main-->
    <div class="d-flex flex-stack flex-grow-1" style="padding: 10px 0;  @if(env('APP_ENV') == 'local') background-color: #4193f1b0; @elseif(env('APP_ENV') == 'test') background-color: #ffc7005c; @endif " >
...
{{--            </a>--}}
            <a href="{{route('system.dashboard')}}" class="brand-logo">
                <h3> Hendawy </h3>
                {{--<img alt="Logo" src="logo/logo-menu-wms.png" style="width:160px;"/>--}}
            </a>
            <!--end::Logo-->
        </div>
        <!--begin::Navbar-->
                                ...
                                <div class="scroll-y mh-200px mh-lg-325px">
                                    <div class="d-flex flex-wrap justify-content-between">
                                        ...
                                        <div class="mb-5 col-6">
                                            <input type="text" id="quick_search_name" oninput="$('#quick_search_id').val('')" class="form-control form-control-sm form-control-solid @if(lang() =='ar') search_id @endif" placeholder="{{__('Name')}}" name="quick_search_name"  />
                                        </div>
                                    </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            ...
                                            <div class="nav-group nav-group-fluid">
                                                <!--begin::Option-->
                                                <label>
                                                    <input type="radio"    class="btn-check"    name="quick_search_type" value="user" checked="checked" />
                                                    <span class="btn btn-sm btn-color-muted btn-active btn-active-primary">{{__('User')}}</span>
                                                </label>
                                                <!--end::Option-->
